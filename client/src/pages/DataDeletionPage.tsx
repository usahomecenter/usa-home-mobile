  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "There was an error submitting your request. Please try again or contact support@usahome.center",
        variant: "destructive"
      });
    } finally {
      setIsLoading(false);
      ...
      {!submitted ? (
        ...
        <div className="bg-green-50 p-5 rounded-lg border border-green-200 text-green-800">
          ...
          <Button
            ...
            onClick={() => {
              // Force a full page navigation to ensure we get to the homepage
