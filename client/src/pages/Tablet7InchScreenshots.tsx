...
export default function Tablet7InchScreenshots() {
  ...
  const downloadScreenshot = () => {
    alert(`To download this 7-inch tablet screenshot:\n\n1. Press F12 to open Developer Tools\n2. Click the mobile device icon 📱\n3. Set device to "Responsive" and enter 1024x1280\n4. Right-click and select "Capture screenshot"\n5. Name it: USA-Home-7inch-${currentPageData?.label.replace(/\s+/g, '-') || 'Screenshot'}.png\n\nThis gives you perfect quality for Google Play Console!`);
  };
      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">
            📱 7-inch Tablet Screenshots for Google Play Console
          </h1>
          
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <h2 className="font-semibold text-blue-900 mb-2">Instructions for 7-inch Tablet Capture:</h2>
            <ol className="list-decimal list-inside text-blue-800 space-y-1 text-sm">
              ...
              <li>Select "Responsive" and set custom size: 1024x1280px (4:5 ratio)</li>
        ...
        {/* 7-inch Tablet Preview Frame */}
        <div className="flex justify-center">
          <div className="relative">
            <div className="bg-black rounded-[1.5rem] p-3 shadow-2xl">
              <div id="tablet-7inch-preview" className="bg-white rounded-[1rem] overflow-hidden" style={{ width: '512px', height: '640px' }}>
                {/* Status Bar */}
            ...
            <div className="absolute -bottom-12 left-0 right-0 text-center">
              <p className="text-sm text-gray-600 font-medium">
                Perfect 4:5 ratio for Google Play Console (1024x1280px when captured at 2x)
              </p>
              <p className="text-xs text-gray-500 mt-1">
                Current preview: 512x640px (scales to full resolution in DevTools)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 bg-green-50 border border-green-200 rounded-lg p-4">
          ...
          <ul className="text-green-800 space-y-1 text-sm">
            <li>• 1024x1280px resolution (4:5 aspect ratio for 7-inch tablets)</li>
            <li>• Between 1,080px and 7,680px on each side</li>
            <li>• PNG format when captured</li>
            <li>• Under 8MB file size</li>
            <li>• Authentic USA Home app content optimized for 7-inch tablets</li>
        ...
        <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <p className="text-yellow-800 text-sm">
            7-inch tablets use a 4:5 aspect ratio (1024x1280) which is different from 10-inch tablets. 
            This format is perfect for showing your content in a compact yet readable tablet format that users will love.
          </p>
        </div>
      </div>
    </div>
